...
<head>
    ...
    <title><?php echo e(config('app.name', 'Heils')); ?> <?php echo e(ucfirst(config('multiauth.prefix'))); ?></title>
        ...
        <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
            <div class="container">
                <a class="navbar-brand" href="<?php echo e(route('admin.home')); ?>">
                    <?php echo e(config('app.name', 'Heils')); ?> <?php echo e(ucfirst(config('multiauth.prefix'))); ?>
...
<?php /**PATH C:\xampp\htdocs\heils\resources\views/vendor/multiauth/layouts/app.blade.php ENDPATH**/ ?>