											...
											<tbody>
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															...
															<a href="profile"> 5e6ec13053ff77727b9840e9</a>
														</h2>
													</td>
													...
													<td class="text-right">
														<div class="actions">
															<a class="btn btn-sm bg-success-light" data-toggle="modal" href="#View_modal">
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															...
															<a href="profile"> 5dee4f9be7b1f61e30a0d639</a>
														</h2>
													</td>
													...
													<td>
														...
														<td>2 Nov 2020<br> <small>08.50 AM</small></td>
													<td class="text-right">
														<div class="actions">
															<a class="btn btn-sm bg-success-light" data-toggle="modal" href="#View_modal">
																<i class="fe fe-eye"></i> View
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															...
															<a href="profile"> 5dee4d3be7b1f61e30a0d632</a>
														</h2>
													</td>
													...
													<td>
														...
														<td>1 Nov 2020<br> <small>02.59 PM</small></td>
													<td class="text-right">
														<div class="actions">
															<a class="btn btn-sm bg-success-light" data-toggle="modal" href="#View_modal">
																<i class="fe fe-eye"></i> View
												...
												<tr>
													...
													<td>
														...
														<td>27 Sep 2020 <br><small>03.40 PM</small></td>
													<td class="text-right">
														<div class="actions">
															<a class="btn btn-sm bg-success-light" data-toggle="modal" href="#View_modal">
																<i class="fe fe-eye"></i> View
												...
												<tr>
													...
													<td>
														...
														<td>24 Sep 2020 <br><small>04.38 PM</small></td>
													<td class="text-right">
														<div class="actions">
															<a class="btn btn-sm bg-success-light" data-toggle="modal" href="#View_modal">
																<i class="fe fe-eye"></i> View
												...
												<tr>
													...
													<td>
														...
														<td>22 Aug 2020 <br><small>01.50 PM</small></td>
													<td class="text-right">
														<div class="actions">
															<a class="btn btn-sm bg-success-light" data-toggle="modal" href="#View_modal">
																<i class="fe fe-eye"></i> View
												...
												<tr>
													...
													<td>
														...
														<td>21 Jul 2020 <br><small>05.50 PM</small></td>
													<td class="text-right">
														<div class="actions">
															<a class="btn btn-sm bg-success-light" data-toggle="modal" href="#View_modal">
																<i class="fe fe-eye"></i> View
												...
												<tr>
													...
													<td>
														...
														<td>16 Jun 2020 <br><small>04.50 PM</small></td>
													<td class="text-right">
														<div class="actions">
															<a class="btn btn-sm bg-success-light" data-toggle="modal" href="#View_modal">
																<i class="fe fe-eye"></i> View
												...
												<tr>
													...
													<td>
														...
														<td>11 Mar 2020 <br><small>05.55 PM</small></td>
													<td class="text-right">
														<div class="actions">
															<a class="btn btn-sm bg-success-light" data-toggle="modal" href="#View_modal">
																<i class="fe fe-eye"></i> View
												...
												<tr>
													...
													<td>
														...
														<td>15 Feb 2020 <br><small>07.30 PM</small></td>
													<td class="text-right">
														<div class="actions">
															<a class="btn btn-sm bg-success-light" data-toggle="modal" href="#View_modal">
																<i class="fe fe-eye"></i> View
					...
					<!--	<div class="modal-header">
						...
						<div class="modal-body">
							<div class="form-content p-2">
                                ...
                                <h5>Booking By: Cypo Hi</h5>
                                <h5>Booking Id: 5dee4d3be7b1f61e30a0d632</h5>
                                <h5>Required Service: Home-care</h5>
                                <h5>Comment: Chhjj</h5>
                                <h5>Duration: 01:00 hrs</h5>
                                <h5>Service Date: Dec 9, 2020</h5>
                                <h5>Service Time: 19:13</h5>
                                <h5>Sevice End Time: 20:13</h5>
                                <h5>Helper Name: Cypo West midlands</h5>
                                <h5>Exact Start Time: 19:37</h5>
                                <h5>Exact End Time: 19:41</h5>
                                <h5>Total Time (in hrs): 1</h5>
							</div>
						</div>
					</div>
				</div>
...
<?php echo $__env->make('layout.mainlayout_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\heils\resources\views/admin/booking.blade.php ENDPATH**/ ?>